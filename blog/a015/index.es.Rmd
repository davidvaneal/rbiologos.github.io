...
Para este ejemplo utilizaremos la variable largo del sépalo (sepal.lenght) de la especue _I. setosa_ de la base _Iris_, asumiendo que cumple con los criterios establecidos para este tipo de test, como lo vimos en nuestro anterior [_POST_](https://rbiologos.com/blog/a014/)
...
Como pudimos leer en este post, hay varios estadísticos que nos permitirán tratar nuestros datos paramétricos, recordemos que deben complir ciertos criterios para ser llamados de esta manera.
