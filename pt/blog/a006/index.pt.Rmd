...
```{r eval=FALSE}
a <- read.table (file = "txt_exemplo.txt", # Nome do arquivo, você também pode especificar o endereço do arquivo
                 cabeçalho = FALSO, # se o cabeçalho for mostrado (VERDADEIRO) ou não (FALSO)
...
<center>
<img src="https://i.ibb.co/VwZDWND/final-606273fa32e29f0085e699da-364467.gif" alt="final-606273fa32e29f0085e699da-364467" border="0"><br>
Salvar arquivos .csv do Excel
</center>
<br>

<center>
<img src="https://i.ibb.co/Pggh11f/Drive-csv.gif" alt="Drive-csv" border="0"><br>
