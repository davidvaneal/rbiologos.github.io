...
Agora se, com tudo o que você já sabe, vai entender melhor a transformação de dados por meio de exemplos, então, vamos torná-lo pequeno:
...
Neste exemplo, ficará um pouco mais claro. Temos uma base de dados <res>Projeto</res> e os locais que foram trabalhados foram numerados, ao invés de ter dado um nome, que problema! Assim, vamos olhar nossos primeiros dados e depois ver o tipo de classe da coluna <res>Lugar</res>, como vemos neste código:
