...
A tip to facilitate your understanding: The vast majority of R code syntax is related to the function they are going to fulfill. For example, <res>getwd()</res> it's **get working Directory**.
</blockquote>
...
Scripts are recognized because they have an <res>.R</res> file extension, for example <res>project.R</res>. These files are the same as any text document, but R can read them and execute the code they contain.
